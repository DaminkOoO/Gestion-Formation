...
<div class="navbar">
    ...
    <h1>Pour la formation: <?= $_GET["intituleFormation"] ?></h1>
    <?php
       /*  if($_GET["nbReservation"]==0)
            echo 
            "<h2>Pas De Reservation En Attente!</h2>";
        else{*/
            $listeDesReservationNonConfirmer=Reservation::getReservationNonConfirmer();
            echo "<table>";
            echo "<tr><th>id</th><th>login</th><th>id_formation</th></tr>";
            foreach ($listeDesReservationNonConfirmer as $formationNonConfirmer) {
                echo $formationNonConfirmer;
            }
            echo "</table>";
        /*}*/
    ?>
